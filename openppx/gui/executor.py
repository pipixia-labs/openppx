...
DEFAULT_GUI_GROUNDING_PROVIDER_ENV = "OPENPPX_GUI_GROUNDING_PROVIDER"
DEFAULT_GUI_BASE_URL_ENV = "OPENPPX_GUI_BASE_URL"
DEFAULT_GUI_ALLOW_DANGEROUS_KEYS_ENV = "OPENPPX_GUI_ALLOW_DANGEROUS_KEYS"
DEFAULT_GUI_MAX_WAIT_SECONDS_ENV = "OPENPPX_GUI_MAX_WAIT_SECONDS"
DEFAULT_GUI_MAX_PARSE_RETRIES_ENV = "OPENPPX_GUI_MAX_PARSE_RETRIES"
DEFAULT_GUI_VERIFY_SCREEN_CHANGE_ENV = "OPENPPX_GUI_VERIFY_SCREEN_CHANGE"
DEFAULT_GUI_MAX_ACTION_RETRIES_ENV = "OPENPPX_GUI_MAX_ACTION_RETRIES"
DEFAULT_GUI_ALLOWED_ACTIONS_ENV = "OPENPPX_GUI_ALLOWED_ACTIONS"
DEFAULT_GUI_BLOCKED_ACTIONS_ENV = "OPENPPX_GUI_BLOCKED_ACTIONS"
    ...
    def __init__(
        ...
        *,
        ...
        self._screenshot_dir = Path(
            screenshot_dir or os.path.join(tempfile.gettempdir(), "openppx_gui")
        )
    ...
    *,
    ...
    if not resolved_api_key:
        if grounding_api_key_env:
            ...
            error_hint = "provider API key env (for OPENPPX_GUI_GROUNDING_PROVIDER)"
        raise ValueError(
