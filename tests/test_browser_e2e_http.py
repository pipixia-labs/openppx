...
class BrowserE2EHttpTests(unittest.TestCase):
            ...
            def do_GET(self) -> None:  # noqa: N802
                ...
                if node_name == "warning-payload-dup-node":
                    payload = {
                        "ok": True,
                        "capabilityWarnings": [
                            "OPENPPX_BROWSER_NODE_CAPABILITY_JSON is invalid JSON; fallback to default proxy capability"
                        ],
                    }
                    body = json.dumps(payload).encode("utf-8")
                    self.send_response(200)
                ...
                if node_name == "warning-payload-dup-sandbox":
                    payload = {
                        "ok": True,
                        "capabilityWarnings": [
                            "OPENPPX_BROWSER_SANDBOX_CAPABILITY_JSON is invalid JSON; fallback to default proxy capability"
                        ],
                    }
                    body = json.dumps(payload).encode("utf-8")
                    self.send_response(200)
    ...
    def _configure_relay_runtime(self, *, token: str | None = None) -> None:
        ...
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_URL"] = self._server_base()
        if token is None:
            os.environ.pop("OPENPPX_BROWSER_CHROME_RELAY_TOKEN", None)
        else:
            os.environ["OPENPPX_BROWSER_CHROME_RELAY_TOKEN"] = token
        configure_browser_runtime(None)

    def test_browser_node_proxy_minimal_e2e(self) -> None:
        configure_browser_runtime(None)
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_NODE_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_NODE_PROXY_TOKEN"] = "node-token-e2e"
    ...
    def test_browser_node_proxy_uses_global_proxy_token_fallback_e2e(self) -> None:
        ...
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_NODE_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_PROXY_TOKEN"] = "global-token-e2e"
    ...
    def test_browser_node_proxy_invalid_recommendation_order_json_uses_default_order_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_RECOMMENDED_ACTIONS_ORDER_JSON"] = "{not-json"
    ...
    def test_browser_node_proxy_non_list_recommendation_order_uses_default_order_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_RECOMMENDED_ACTIONS_ORDER_JSON"] = json.dumps({"bad": "shape"})
    ...
    def test_browser_sandbox_proxy_capability_error_codes_are_deduplicated_e2e(self) -> None:
        configure_browser_runtime(None)
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_CAPABILITY_JSON"] = json.dumps(
            {"capability": {"errorCodes": ["proxy_timeout", " proxy_timeout ", "custom_error", ""]}}
        )
    ...
    def test_browser_sandbox_proxy_minimal_e2e(self) -> None:
        ...
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_TOKEN"] = "sandbox-token-e2e"
    ...
    def test_browser_node_proxy_invalid_capability_json_warns_and_falls_back_e2e(self) -> None:
        ...
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_NODE_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_NODE_CAPABILITY_JSON"] = "{not-json"
    ...
    def test_browser_node_proxy_non_object_capability_json_warns_and_falls_back_e2e(self) -> None:
        ...
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_NODE_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_NODE_CAPABILITY_JSON"] = json.dumps(["not-an-object"])
    ...
    def test_browser_sandbox_proxy_invalid_capability_json_warns_and_falls_back_e2e(self) -> None:
        ...
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_CAPABILITY_JSON"] = "{bad-json"
    ...
    def test_browser_sandbox_proxy_non_object_capability_json_warns_and_falls_back_e2e(self) -> None:
        ...
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_CAPABILITY_JSON"] = json.dumps(["not-an-object"])
    ...
    def test_browser_sandbox_proxy_status_includes_recommendations_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_RECOMMENDED_ACTIONS_LIMIT"] = "3"
    ...
    def test_browser_sandbox_proxy_recommendation_limit_is_clamped_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_RECOMMENDED_ACTIONS_LIMIT"] = "0"
    ...
    def test_browser_sandbox_proxy_recommendation_limit_is_capped_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_RECOMMENDED_ACTIONS_LIMIT"] = "999"
    ...
    def test_browser_node_proxy_invalid_recommendation_limit_uses_default_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_RECOMMENDED_ACTIONS_LIMIT"] = "not-an-int"
    ...
    def test_browser_sandbox_proxy_invalid_json_mapping_e2e(self) -> None:
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_TOKEN"] = "mode-invalid-json"
    ...
    def test_browser_sandbox_proxy_non_object_json_mapping_e2e(self) -> None:
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_TOKEN"] = "mode-non-object-json"
    ...
    def test_browser_sandbox_proxy_timeout_mapping_e2e(self) -> None:
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_TOKEN"] = "mode-slow"
    ...
    def test_browser_sandbox_proxy_connection_refused_mapping_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://127.0.0.1:{free_port}"
    ...
    def test_browser_sandbox_proxy_http_error_uses_structured_status_and_error_code_e2e(self) -> None:
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_TOKEN"] = "mode-structured-error"
    ...
    def test_browser_sandbox_proxy_auth_success_e2e(self) -> None:
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_TOKEN"] = "node-token-ok"
        self._captured["proxy_mode"] = "auth-required"
    ...
    def test_browser_sandbox_proxy_empty_body_e2e(self) -> None:
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_SANDBOX_PROXY_TOKEN"] = "mode-empty-body"
    ...
    def test_browser_chrome_relay_act_evaluate_minimal_e2e(self) -> None:
        self._configure_relay_runtime()
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_EVALUATE_ENABLED"] = "1"
    ...
    def test_browser_chrome_relay_act_evaluate_too_long_e2e(self) -> None:
        self._configure_relay_runtime()
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_EVALUATE_ENABLED"] = "1"
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_EVALUATE_MAX_CHARS"] = "8"
    ...
    def test_browser_chrome_relay_act_body_too_large_e2e(self) -> None:
        self._configure_relay_runtime()
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_MAX_BODY_BYTES"] = "256"
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_TYPE_MAX_CHARS"] = "200000"
    ...
    def test_browser_chrome_relay_act_timeout_mapping_e2e(self) -> None:
        self._configure_relay_runtime()
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_TIMEOUT_MS"] = "50"
    ...
    def test_browser_chrome_relay_connection_refused_mapping_e2e(self) -> None:
        ...
        os.environ["OPENPPX_BROWSER_RUNTIME"] = "playwright"
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_URL"] = f"http://127.0.0.1:{free_port}"
        configure_browser_runtime(None)
    ...
    def test_browser_chrome_relay_dns_failed_mapping_e2e(self) -> None:
        os.environ["OPENPPX_BROWSER_RUNTIME"] = "playwright"
        os.environ["OPENPPX_BROWSER_CHROME_RELAY_URL"] = "http://does-not-exist-relay-host.invalid:9800"
        configure_browser_runtime(None)
    ...
    def test_browser_node_proxy_auth_success_e2e(self) -> None:
        host, port = self._server.server_address
        os.environ["OPENPPX_BROWSER_NODE_PROXY_URL"] = f"http://{host}:{port}"
        os.environ["OPENPPX_BROWSER_NODE_PROXY_TOKEN"] = "node-token-ok"
    ...
    def test_browser_chrome_relay_upload_fallback_e2e(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with open(path, "w", encoding="utf-8") as f:
                f.write("demo")
            os.environ["OPENPPX_BROWSER_UPLOAD_ROOT"] = tmpdir
    ...
    def test_browser_chrome_relay_screenshot_save_e2e(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            os.environ["OPENPPX_BROWSER_ARTIFACT_ROOT"] = tmpdir
