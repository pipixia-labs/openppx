...
class ConfigTests(unittest.TestCase):
    ...
    def test_load_missing_returns_defaults(self) -> None:
        ...
        self.assertIn(".openheron/agents/main/workspace", cfg["agent"]["workspace"])
        self.assertIn(".openheron/agents/{agentId}/workspace", cfg["agents"]["defaults"]["workspace"])
        self.assertIn(".openheron/agents/main", cfg["agents"]["list"][0]["agentDir"])
    ...
    def test_gui_builtin_tools_flag_is_exported(self) -> None:
        ...
        self.assertEqual(os.environ["OPENHERON_GUI_BUILTIN_TOOLS_ENABLED"], "0")
